...
function Acessar () 
{
    ...
    var idade = parseInt(document.querySelector("nputiIdade").value);

    var validarCanpos = validar (nome, idade, cidade );
}

function validar (nome, idade, cidade )
{
    document.querySelector("#resultados").innerHTML = `
    <div class="alert alert-danger fade show"accordion 
        <div class="d-flex justify-content-between ">
            <span>Preencher todos os campos</span>
